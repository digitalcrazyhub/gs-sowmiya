...
import { initCardTilt, initScrollReveal, initCounterAnimation } from '/assets/js/animations.js';
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  await loadGlobalComponents({
    ...
    banner: {
      ...
      title: 'PROJECTS THAT SPEAK<br>FOR THEMSELVES.',
      breadcrumb: 'PROJECTS',
      desc: 'Explore selected construction projects and discover the spaces, structures and environments created through our work.',
